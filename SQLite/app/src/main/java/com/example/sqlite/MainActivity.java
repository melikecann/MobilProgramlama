...
public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Kaydet = findViewById(R.id.btn_kayitEkle);
            Goster = findViewById(R.id.btn_kayitGoster);
            Sil = findViewById(R.id.btn_kayitSil);
            Guncelle = findViewById(R.id.btn_kayitGuncelle);
            ...
            yas = findViewById(R.id.editTextYas);
            sehir = findViewById(R.id.editTextSehir);
            Bilgiler = findViewById(R.id.textView2);
